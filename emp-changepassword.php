                    ...
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                              <span class="card-title">Panduan Aplikasi</span>
                                <p>Silahkan anda membuat working permit baru, lalu menunggu persetujuan. <br> Jika disetujui, barulah anda bisa mengisi formulir WP Approval (izin kerja) <br><span style="color:red">jangan beritahu email dan username anda kepada siapapun!</span></p>
                                <div class="row">
