        ...
        <span class="chapter-title">Admin WP</span>
        </div>
        
        <ul class="right col s2 m3 nav-right-menu">
        
        <li><a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button dropdown-right show-on-large"><i class="material-icons">notifications</i>
        <?php 
        $isread=0;
        $Status=0;
